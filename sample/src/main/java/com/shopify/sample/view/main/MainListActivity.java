...
public class MainListActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainListView mainListView = (MainListView) findViewById(R.id.collection_list);
        mainListView.bindViewModel(ViewModelProviders.of(this).get(MainListViewModel.class));
    }
